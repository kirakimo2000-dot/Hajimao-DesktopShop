...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/build-portable.ps1 -Version 0.2.4 -PrunePrevious
```

成功后会生成：

- 根目录 `Hajimao DesktopShop.exe`
- `artifacts/release/0.2.4/HajimaoDesktopShop-0.2.4-win-x64-portable.zip`
