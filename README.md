...
## 当前版本：0.1.23 Playable Demo Candidate 1
...
0.1.23 完成品牌、经营形态、动态扩张、无限街区与 schema v7 底层，并加入 24 品牌、40 商品和单店精选货盘。自动策略和端到端测试不能替代人类理解证据；完成三轮真实陌生玩家测试前，项目不会把 Candidate 写成正式 Demo 1。
