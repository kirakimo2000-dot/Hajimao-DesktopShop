...
## Source Brief Gap Audit (updated 2026-08-04)

- 原始桌面文件同时描述第一阶段与中后期愿景；0.1.0～0.1.7 已增量完成双窗口、多店经营、挂机存档、采购、员工、成长、管理前端和正式像素底座，不能把原型时期的缺口继续当成当前状态。
...
- 管理窗已有店铺、商品、进货、员工、成长、财务和商业街七区真实页面；桌面已有右键快捷菜单、锁定、穿透、静音和托盘恢复，剩余交互缺口主要是场景对象点击与完整新手引导。
...
- 顾客当前有进店→找货→排队→结账→离开的经营状态和四帧短动作，但尚无逐货架路径、拿货/结账/离店的完整分段动作；商业街场景将继续深化。
- 需求已包含价格接受度、服务、队列、整洁度、时段、成长和促销整数分项；仍缺商业街层的路过判定、共享街道事件、车辆与天气。
...
- 仍未实现的主要完整愿景集中在 0.1.8 商业街共享场景，以及 0.1.9 教程、平衡、长时稳定、安装包和多显示器发布验收。
