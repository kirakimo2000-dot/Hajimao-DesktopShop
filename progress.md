...
## 2026-08-03 · 0.2.0 多店模拟与经营深度

- 在隔离 worktree `feature/v0.2-multi-store-economy` 实现，0.1.0 主分支和正式制品未被覆盖。
...
- 0.2 不改旧 WPF 页面和 SQLite schema；完整多店存档、离线结算与组合根接入属于 0.3。
- 阶段报告：`docs/progress/v0.2.0-multi-store-economy.md`。
